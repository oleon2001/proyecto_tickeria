...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.fecha_ini = self.create_date_input("Fecha Inicio")
        self.fecha_fin = self.create_date_input("Fecha Fin")
        ...
        self.borrar_seleccion_btn = QPushButton("Limpiar Selección")
        self.borrar_seleccion_btn.setObjectName("secondary")
        self.ejecutar_btn = QPushButton("Generar Reporte", icon=QIcon(":icons/chart.png"))
        self.ejecutar_btn.setIconSize(QSize(20, 20))
    ...
    "Tickets Reabiertos", "Proporción Reabiertos/Cerrados (%)", "Acción"  # 10 columnas (0-9)
        ])
