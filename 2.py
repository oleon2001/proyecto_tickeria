...
class MainWindow(QMainWindow):
    ...
    def mostrar_resultados(self, resultados):
        df_tickets = pd.DataFrame(resultados, columns=[
            ...
            "Total_Cerrados", "Total_Recibidos", "Cumplimiento_TR_TC", "Reabiertos"
        ])
        ...
        tree.setHeaderLabels([
            ...
            "Total Cerrados", "Tickets Recibidos", "Cumplimiento TR/TC (%)",
            "Tickets Reabiertos", "Acción"
        ])
        ...
        for _, row in df_tickets.iterrows():
            item = QTreeWidgetItem([
                ...
                str(row["Total_Cerrados"]),
                str(row["Total_Recibidos"]),
                str(row["Cumplimiento_TR_TC"]),
                str(row["Reabiertos"])
            ])
