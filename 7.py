...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.setMinimumSize(450, 300)  # Ajustar el tamaño mínimo
        ...
        # Campos de fecha
        input_layout.addWidget(QLabel("Rango de Fechas:"))
        ...
        input_layout.addWidget(self.fecha_ini)
        input_layout.addWidget(self.fecha_fin)

        # Opciones de técnicos
        input_layout.addWidget(QLabel("Selección de Técnicos:"))
        ...
        input_layout.addWidget(self.radio_todos)
        input_layout.addWidget(self.radio_seleccion)
        input_layout.addWidget(self.borrar_seleccion_btn)
